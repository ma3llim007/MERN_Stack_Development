        ...
        <>
            <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
                ...
                <div className="mt-4">
                    ...
                    <button className="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" onClick={() => dispatch(addToCart(data))}>Add To Cart</button>
                </div>
            </div>
        </>
    )
